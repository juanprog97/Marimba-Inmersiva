...
public class BluetoothService
{
    ...
    private static AndroidJavaObject disp;
    ...
    public static void CreateBluetoothObject()
    {
        if (Application.platform == RuntimePlatform.Android)
        {
            ...
            disp = activity.Call<AndroidJavaObject>("getSystemService", "bluetooth");
            BluetoothConnector = disp.Call<AndroidJavaObject>("getAdapter");
            BluetoothConnector.Call<bool>("enable");
